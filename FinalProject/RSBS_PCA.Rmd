...
us_states<-read_sf("shape_files/USA_States_Generalized.shp")
new_england <- us_states[us_states$SUB_REGION == "New England",]
south_atl <- us_states[us_states$SUB_REGION =="South Atlantic",]
mid_atl <- us_states[us_states$SUB_REGION =="Middle Atlantic",]
wn_central <- us_states[us_states$SUB_REGION == "West North Central",]
en_central <- us_states[us_states$SUB_REGION == "East North Central",]
es_central <- us_states[us_states$SUB_REGION == "East South Central",]
east_coast <- bind_rows(new_england, south_atl, wn_central, mid_atl, en_central, es_central)


plot(east_coast[c(-17,-20,-21,-22),4], reset=FALSE, col="white")
make.admix.pie.plot(admix.proportions = pop_admix_avg,
                    coords = pop_coords,
                    layer.colors = c("blue", "green", "yellow"),
                    add = TRUE,
                    x.lim = NULL,
                    y.lim = NULL)
