...
input="res_F0_OWvAM_LFC.csv" # two columns of comma-separated values: gene id, continuous measure of significance. To perform standard GO enrichment analysis based on Fisher's exact test, use binary measure (0 or 1, i.e., either significant or not).
...
FO_OWvAM_LFC_GOMWUstats.rds <- gomwuStats(input, goDatabase, goAnnotations, goDivision,
